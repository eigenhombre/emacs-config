...
* Shell stuff, for running shells within Emacs
** Path Magic
...
'Remember' stuff[fn::
http://sachachua.com/blog/2007/12/emacs-getting-things-done-with-org-basic/]. TODO:
use Org's own capture system.
...
* Blogging
This is taken from [[http://bzg.fr/blogging-from-emacs.html][=http://bzg.fr/blogging-from-emacs.html=]] and
